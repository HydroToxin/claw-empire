...
export function registerAgentCrudRoutes(ctx: RuntimeContext): void {
  ...
  app.post("/api/agents", (req, res) => {
    try {
      ...
      const cli_provider =
        ...
        ["claude", "codex", "gemini", "opencode", "kimi", "copilot", "antigravity", "api", "pi"].includes(body.cli_provider)
          ? body.cli_provider
          : "claude";
      const avatar_emoji =
  ...
  app.patch("/api/agents/:id", (req, res) => {
    ...
    const supportsCliModelOverride = ["claude", "codex", "gemini", "opencode", "kimi", "pi"].includes(nextProvider);
